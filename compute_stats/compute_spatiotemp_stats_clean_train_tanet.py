...
if __name__ == '__main__':
    ...
    args.video_data_dir = '/scratch/project_465001897/datasets/ss2/videos/samples_mp4' # Use fish dataset videos
    args.val_vid_list = '/scratch/project_465001897/datasets/ss2/videos/train_rgb.txt' # Use fish training data for statistics
    # todo ========================= To Specify ==========================
